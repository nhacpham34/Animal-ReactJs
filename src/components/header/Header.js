        ...
        <div className="header">
            <div className="header-top grid wide">
                ...
                <div className="header-top__item">
                    <p className="header-top-sectors">Xin chào {localStorage.getItem("nameToken")}</p>
            ...
            <nav className="header-body grid wide">
                <ul className="navbar__list">
                    <li className="navbar__item">
                        <img  alt="" className="navbar__item-logo" />
                    </li>
                    <li className="navbar__item">
                        <ul className="navbar__item-list">
                            ...
                            <li className="navbar__item-sectors">
                                <a className="navbar__item-link" href="#shop-boys">LĨNH VỰC HOẠT ĐỘNG</a>
                            </li>
                            <li className="navbar__item-sectors">
